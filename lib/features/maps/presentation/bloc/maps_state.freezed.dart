...
mixin _$MapsState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(MapSettings settings) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(MapSettings settings)? loaded,
...
class _$MapsLoadedImpl implements MapsLoaded {
  const _$MapsLoadedImpl(this.settings);
  ...
  @override
  String toString() {
    return 'MapsState.loaded(settings: $settings)';
  }
...
abstract class MapsLoaded implements MapsState {
  const factory MapsLoaded(final MapSettings settings) = _$MapsLoadedImpl;

  MapSettings get settings;
