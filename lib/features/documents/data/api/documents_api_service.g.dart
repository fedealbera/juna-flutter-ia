...
part of 'documents_api_service.dart';
...
class _DocumentsApiService implements DocumentsApiService {
  ...
  Future<List<ParticipantFileResponseDto>> getParticipantFiles(
    ...
    late List<ParticipantFileResponseDto> _value;
    try {
      _value = _result.data!
          .map((dynamic i) =>
              ParticipantFileResponseDto.fromJson(i as Map<String, dynamic>))
          .toList();
    } on Object catch (e, s) {
  ...
  Future<UploadFileResponseDto> uploadFile(
    ...
    final _options = _setStreamType<UploadFileResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
