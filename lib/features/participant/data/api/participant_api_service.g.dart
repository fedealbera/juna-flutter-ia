...
class _ParticipantApiService implements ParticipantApiService {
  ...
  Future<UpdateParticipantResponseDto> updateParticipant(
    String partiId,
    UpdateParticipantRequestDto body,
  ) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<UpdateParticipantResponseDto>(Options(
      method: 'PUT',
      headers: _headers,
      extra: _extra,
    )
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late UpdateParticipantResponseDto _value;
    try {
      _value = UpdateParticipantResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  @override
  Future<dynamic> getParticipantDocuments(String partiId) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
  ...
  @override
  Future<dynamic> authorizeKit(KitAuthorizationRequestDto body) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = body;
    final _options = _setStreamType<dynamic>(Options(
      ...
      extra: _extra,
        ...
        .compose(
          _dio.options,
          '/api/participantes/autorizacion',
          queryParameters: queryParameters,
          data: _data,
        )
        .copyWith(
