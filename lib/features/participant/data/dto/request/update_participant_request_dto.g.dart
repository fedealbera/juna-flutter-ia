...
_$UpdateParticipantRequestDtoImpl _$$UpdateParticipantRequestDtoImplFromJson(
        Map<String, dynamic> json) =>
    _$UpdateParticipantRequestDtoImpl(
      contNombre: json['contNombre'] as String?,
      contTel: json['contTel'] as String?,
...
Map<String, dynamic> _$$UpdateParticipantRequestDtoImplToJson(
        _$UpdateParticipantRequestDtoImpl instance) =>
    <String, dynamic>{
      'contNombre': instance.contNombre,
      'contTel': instance.contTel,
