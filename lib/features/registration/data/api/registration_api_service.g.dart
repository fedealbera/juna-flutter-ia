...
class _RegistrationApiService implements RegistrationApiService {
  ...
  Future<ValidateDiscountResponseDto> validateDiscount(
    ...
    final _data = body;
    final _options = _setStreamType<ValidateDiscountResponseDto>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
        .compose(
          _dio.options,
          '/api/inscripciones/${insId}/descuento',
    ...
    late ValidateDiscountResponseDto _value;
    try {
      _value = ValidateDiscountResponseDto.fromJson(_result.data!);
    } on Object catch (e, s) {
