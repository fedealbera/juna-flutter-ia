...
* **`MoreScreen`:** Embeds contact messages, application sharing, and brand info.
  * **WhatsApp Card:** Uses the official `FontAwesomeIcons.whatsapp` logo, titled "WhatsApp" and directly formatted phone number.
  * **Mail Card:** Titled "Mail", displaying the email with the SLA note "Respuesta en hasta 48 h.".
